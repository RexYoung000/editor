...
- 三个及以上元素支持水平、垂直等间距吸附、辅助线和实际距离提示
- 标尺（水平 + 垂直，百分比定位）
- Ctrl+S 保存
...
2026-07-16 第四批等间距与辅助设置已完成实现、待 Electron 视觉验收：画布顶部集中提供网格显示、网格吸附、智能吸附、参考线和等距提示五项全局偏好与恢复默认；水平、垂直等间距支持内部与外侧排列、实际距离和稳定吸附。完整 66 项单元测试、Lint 与生产构建通过。
