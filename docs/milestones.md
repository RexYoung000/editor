...
v1.2.0 纳入数字小数点与分数键盘、锁定图层命中、单框多答案与两框算式关系、选择题配置四项已完成能力，当前进入发布候选和安装包验证阶段。完整范围、验收边界和发布限制见 [v1.2.0 需求基线](./roadmap/v1.2.0-requirements.md) 与 [v1.2.0 发布记录](./releases/v1.2.0.md)。资源库独立搜索与三级快捷筛选 #73 从本版本移出，顺延至 [v1.2.1 需求基线](./roadmap/v1.2.1-requirements.md)。
