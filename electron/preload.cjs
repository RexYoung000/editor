...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  svnCommit: (dirPath) => ipcRenderer.invoke('svn-commit', dirPath),
  svnGetUrl: (dirPath) => ipcRenderer.invoke('svn-get-url', dirPath),
  svnHasUnversioned: (dirPath) => ipcRenderer.invoke('svn-has-unversioned', dirPath),
