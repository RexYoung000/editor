...
export default function TabImgPicker({ currentSkin, onSelect, onClose }: Props) {
  const { t } = useI18n();
  const ids = getResourceGroupIds('tabImg');
          ...
          <div className="grid grid-cols-6 gap-2">
            {ids.map((id) => {
              ...
              return (
                ...
                >
                  <img src={assetSrc(id)} className="w-full h-20 object-contain bg-slate-900" />
                  {isSelected && (
