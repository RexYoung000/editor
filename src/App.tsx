...
function App() {
  ...
  }, [undo, redo, copyElements, pasteElements, duplicateElements, selectAll, groupElements, ungroupElements, currentCourse, phase]);
        ...
        <div className="h-screen flex flex-col bg-slate-900 text-white">
          ...
          <div className="flex-1 flex overflow-hidden">
            <div className="w-60 bg-slate-800 border-r border-slate-700 flex flex-col overflow-hidden">
              <div className="flex-[0_1_60%] flex flex-col overflow-hidden min-h-0">
                <PageList />
              </div>
              <div className="flex-[1_0_40%] flex flex-col overflow-hidden min-h-0 border-t border-slate-700">
                <ElementList />
              </div>
            </div>
