...
export { applyElementTransform, preloadAtlas, registerObject, getObject, removeObject, clearAllObjects, syncTransform, syncProps, initWorldRoot, worldRoot, canvasRoot, setWorldTransform, getWorldTransform, boundaryFrame } from './laya/core';
